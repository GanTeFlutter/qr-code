...
List<RouteBase> get $appRoutes => [$splashRoute, $onboardingRoute, $homeRoute];
...
mixin $CreateQrRoute on GoRouteData {
  static CreateQrRoute _fromState(GoRouterState state) =>
      CreateQrRoute($extra: state.extra as QrHistoryCacheModel?);

  CreateQrRoute get _self => this as CreateQrRoute;

  @override
  String get location => GoRouteData.$location('/create-qr');
